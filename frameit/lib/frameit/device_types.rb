...
module Frameit
  ...
  module Devices
    ...
    SAMSUNG_GALAXY_S21_PLUS ||= Frameit::Device.new("samsung-galaxy-s21-plus", "Samsung Galaxy S21+ 5G", 9, [[1180, 2500], [2500, 1180]], 522, Color::BLACK, Platform::ANDROID)
    GOOGLE_PIXEL_SLATE ||= Frameit::Device.new("google-pixel-slate", "Google Pixel Slate", 1, [[2304, 3313], [3313, 2304]], 100, nil, Platform::ANDROID)
