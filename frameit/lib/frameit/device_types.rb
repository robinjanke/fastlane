...
module Frameit
  ...
  module Devices
    ...
    SAMSUNG_GALAXY_S21_PLUS ||= Frameit::Device.new("samsung-galaxy-s21-plus", "Samsung Galaxy S21+", 9, [[1180, 2500], [2500, 1180]], 522, Color::BLACK, Platform::IOS)
    GOOGLE_PIXEL_SLATE ||= Frameit::Device.new("google-pixel-slate", "Google Pixel Slate", 1, [[3313, 2304], [2304, 3313]], 522, Color::BLACK, Platform::IOS)
